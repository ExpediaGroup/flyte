...
Flyte has chat-ops enabling integrations for Slack and HipChat, as well as integrations with BitBucket, JIRA, Consul, Serf, SMTP, LDAP, and the ability to execute shell scripts, etc. These can be added to and extended easily by using Flyte's RESTful API.
